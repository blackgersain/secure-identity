...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__dtos_kairos_verify_rs__ = __webpack_require__(276);
...
var KairosProvider = /** @class */ (function () {
    ...
    KairosProvider.prototype.verify = function (kairosVerifyRq) {
        var _this = this;
        var url = "https://api.kairos.com/verify";
        ...
        return this.http.post(url, kairosVerifyRq.stringify(), { headers: headers })
            ...
            if (resultStr.includes("Errors") && !resultStr.includes("5004"))
                throw new Error("kairos verify with errors: " + resultStr);
            if (resultStr.includes("Errors") && resultStr.includes("5004"))
                _this.common.presentAcceptAlert('Alerta', 'El documento ingresado no coincide con el perfil facial.');
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers_kairos_kairos__ = __webpack_require__(242);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__kairos_verify_rs_image__ = __webpack_require__(277);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__kairos_verify_rs_transaction__ = __webpack_require__(278);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_splash_screen__ = __webpack_require__(239);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__shared_pages__ = __webpack_require__(241);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
