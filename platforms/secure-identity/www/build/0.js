...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__dtos_kairos_verify_rq__ = __webpack_require__(408);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_common_common__ = __webpack_require__(125);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_kairos_kairos__ = __webpack_require__(242);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__shared_pages__ = __webpack_require__(241);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__shared_patients__ = __webpack_require__(409);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HomePage = /** @class */ (function () {
    ...
    HomePage.prototype.verifyImage = function (image) {
        var _this = this;
        ...
        this.kairosProvider.verify(kairosVerifyRq).subscribe(function (kairosVerifyRs) {
            ...
            _this.common.presentAcceptAlert('Información', "kairosProvider.verify success " + JSON.stringify(kairosVerifyRs));
            ...
            _this.formGroup.value.nombreFormCtrl.setValue(patient.name);
            _this.formGroup.value.apellidoFormCtrl.setValue(patient.surname);
        }, function (error) {
    ...
    HomePage.prototype.validarIdentidad = function () {
        ...
        this.kairosProvider.verify(kairosVerifyRq).subscribe(function (kairosVerifyRs) {
            console.log('Kairos response: ' + JSON.stringify(kairosVerifyRs));
            _this.common.presentAcceptAlert('Información', "Validación de identidad por reconocimiento facial realizada exitosamente.");
            var patient = __WEBPACK_IMPORTED_MODULE_7__shared_patients__["a" /* PATIENTS */].find(function (_patient) { return _patient.id == kairosVerifyRs.images[0].transaction.subjectId; });
            _this.formGroup.value.nombreFormCtrl.setValue(patient.name);
            _this.formGroup.value.apellidoFormCtrl.setValue(patient.surname);
        }, function (error) {
